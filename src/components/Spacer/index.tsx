...
import React, { CSSProperties, PropsWithChildren, ReactElement, HTMLAttributes } from "react";

interface SpacerProps extends PropsWithChildren, HTMLAttributes<HTMLDivElement> {
